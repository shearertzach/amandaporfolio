    ...
    return (
        <main className='min-h-[calc(100vh-120px)] flex flex-col items-center p-2'>
            <div className='max-w-xl mt-16 text-center'>
                <h2 className='text-2xl mb-6'>Let’s collaborate, chat, and design together!</h2>
                <p className='mb-4'>I’m always happy to hear from designers, developers, and curious people. Send a message and let’s talk research, design, or ideas!</p>
